...
```
"/Applications/Google Chrome.app/Contents/MacOS/Google Chrome" --headless --disable-gpu --no-pdf-header-footer --print-to-pdf="三浦さん_納品と指示書PDFの新しい手順_2026-09.pdf" "file://$PWD/三浦さん_納品と指示書PDFの新しい手順_2026-09.html"
```
...
- 各 `.page` は A4(210mm × 297mm)ちょうど。**内容がはみ出すと空白ページが1枚増える**ので、
  ...
  制作実績の登録ガイド=2ページ / 検品チェックシート=2ページ / 納品と指示書PDFの新しい手順=3ページ)。
